...
def main():
    ...
    parser.add_argument('--par_dir', default=r'./parameters/parameters_learning.yaml',
                         type=str, help='path to the parameter yaml file')
    ...
    model = Model_Implementation(
                                 path_data_model=par_dict['path_data_model'],
                                 mode=par_dict['mode'],
